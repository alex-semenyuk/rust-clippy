...
* [`never_loop`] do not consider `return` as preventing the iterator from looping; lint diverging
  ...
  [#16222](https://github.com/rust-lang/rust-clippy/pull/16222)
...
* Multiple lints fix wrongly unmangled macros
  [#16354](https://github.com/rust-lang/rust-clippy/pull/16354)
  [#16337](https://github.com/rust-lang/rust-clippy/pull/16337)
* [`large_stack_arrays`] do not warn for libtest harness; [`derive_ord_xor_partial_ord`] allow
  `expect` on `impl` block; [`match_bool`] restrict to 2 arms
...
* [`manual_saturating_arithmetic`] lint `x.checked_sub(y).unwrap_or_default()`;
  [`transmute_ptr_to_ref`] handle pointer in struct; [`disallowed_methods`] skip
  compiler-generated code; [`missing_enforced_import_rename`] do not enforce for "as _"
